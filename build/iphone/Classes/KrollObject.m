 ...
 * Copyright (c) 2009-2011 by Depot, Inc. All Rights Reserved.
...
//@interface DepotObject : NSObject
//@end

@interface DepotObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DepotObject class]])
		{
			for (NSString *key in [[(DepotObject*)o modules] allKeys])
			{
